...
- [pnpm 工作空间配置:1-12](file://pnpm-workspace.yaml#L1-L12)
- [Git 工作区忽略配置:1-63](file://.gitignore#L1-L63)
- [Web 应用 package.json:1-50](file://apps/web/package.json#L1-L50)
- [服务端应用 package.json:1-72](file://server/package.json#L1-L72)
- [配置包 package.json:1-29](file://packages/config/package.json#L1-L29)
- [公共包 package.json:1-20](file://packages/common/package.json#L1-L20)
...
- [Vite 配置:1-31](file://apps/web/vite.config.ts#L1-L31)
- [Git 工作区忽略配置:1-63](file://.gitignore#L1-L63)
...
- [Web 应用 TypeScript 应用配置:1-16](file://apps/web/tsconfig.app.json#L1-L16)
...
- [Prisma 配置:1-16](file://server/prisma.config.ts#L1-L16)
- [配置包导出:1-8](file://packages/config/index.ts#L1-L8)
- [Git 工作区忽略配置:1-63](file://.gitignore#L1-L63)
...
**图表来源**
- [pnpm 工作空间配置:1-12](file://pnpm-workspace.yaml#L1-L12)
- [配置包 package.json:21-27](file://packages/config/package.json#L21-L27)
...
**章节来源**
- [根 package.json:2-7](file://package.json#L2-L7)
...
**图表来源**
- [Web 应用 package.json:13-34](file://apps/web/package.json#L13-L34)
- [服务端应用 package.json:22-54](file://server/package.json#L22-L54)
- [Web 应用 TypeScript 应用配置:1-16](file://apps/web/tsconfig.app.json#L1-L16)
- [Web 应用 TypeScript 节点配置:1-28](file://apps/web/tsconfig.node.json#L1-L28)
- [服务端 TypeScript 根配置:1-35](file://server/tsconfig.json#L1-L35)
- [Prisma 配置:1-16](file://server/prisma.config.ts#L1-L16)
...
- [配置包导出:1-8](file://packages/config/index.ts#L1-L8)
- [Vite 配置:10-18](file://apps/web/vite.config.ts#L10-L18)
- [Prisma 配置:3-15](file://server/prisma.config.ts#L3-L15)
- [Web 应用 TypeScript 根配置:1-12](file://apps/web/tsconfig.json#L1-L12)
- [服务端 TypeScript 根配置:1-35](file://server/tsconfig.json#L1-L35)
- [pnpm 工作空间配置:1-12](file://pnpm-workspace.yaml#L1-L12)
- [Git 工作区忽略配置:1-63](file://.gitignore#L1-L63)
